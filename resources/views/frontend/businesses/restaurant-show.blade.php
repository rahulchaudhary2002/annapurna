...
@section('meta_title', ($business->meta_title ?: $business->name) . ' - Restaurants in Annapurna Region')
...
@section('content')
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-9 text-left caption mt-90">
                    <h5><a href="{{ route('restaurants.index') }}">Restaurants in Pokhara</a> / {{ $business->name }}</h5>
                    <h1>{{ $business->name }}</h1>
                ...
                <div class="col-md-7">
                    <div class="country">
                        ...
                        <div class="butn-dark mt-30 mb-30">
                            <a href="#reservation"><span>Make a Reservation <i class="ti-arrow-right"></i></span></a>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-5">
                    <div class="owl-carousel owl-theme">
                        ...
                        @else
                            <div class="item">
                                <div class="position-re o-hidden">
                                    <img src="{{ asset('annapurna/img/restaurants/default-restaurant.jpg') }}" alt="{{ $business->name }}">
                                </div>
                                <span class="category"><a href="#">Restaurant Photo</a></span>
                            </div>
                        @endif
                    </div>
                </div>
    ...
    <section class="section-padding bg-lightnav">
        <div class="container">
            <div class="row">
                <div class="col-md-8">
                    <div class="section-subtitle"><span>About the Restaurant</span></div>
                ...
                <div class="col-md-4">
                    <div class="widget clearfix" style="background:#f9f7f2;border:1px solid #e8e2d4;padding:28px;border-radius:8px;margin-top:10px;">
                        <h4 style="margin-bottom:18px;color:#0f2454;">Visit {{ $business->name }}</h4>
                        @if($business->phone)
                        ...
                        <div style="display:flex;align-items:flex-start;gap:10px;margin-bottom:12px;">
                            <i class="ti-time" style="color:#c8a96e;font-size:16px;margin-top:2px;"></i>
                            <span style="color:#555;font-size:14px;">{{ $business->opening_hours }}</span>
                        </div>
                        @endif
                        @if($business->address)
                        ...
                        <div class="butn-dark" style="margin-top:10px;">
                            <a href="#reservation"><span>Make Reservation <i class="ti-arrow-right"></i></span></a>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="container">
            <div class="row justify-content-center mb-40">
                <div class="col-md-8 text-center">
                    ...
                    <div class="section-title">Menu &amp; <span>Services</span></div>
                </div>
            </div>
            <div class="row">
    ...
    <section class="section-padding bg-lightnav">
        <div class="container">
            <div class="row justify-content-center mb-40">
                <div class="col-md-8 text-center">
                    <div class="section-subtitle"><span>Inside the Restaurant</span></div>
    ...
    <section class="tours1 section-padding">
        <div class="container">
            <div class="row justify-content-center mb-40">
                <div class="col-md-8 text-center">
                    <div class="section-subtitle"><span>See Us in Action</span></div>
                    <div class="section-title">Restaurant <span>Video</span></div>
                </div>
            </div>
        ...
        <div class="container">
            <div class="row justify-content-center mb-30">
                <div class="col-md-8 text-center">
                    ...
                    <div class="section-title">Special <span>Packages</span></div>
                </div>
            </div>
            <div class="row">
                    ...
                    <div class="item">
                        <a href="{{ route('packages.show', $package->slug) }}">
                            <div class="position-re o-hidden">
                                ...
                                @else
                                    <img src="{{ asset('annapurna/img/restaurants/default-restaurant.jpg') }}" alt="{{ $package->name }}">
                                @endif
                            </div>
                        </a>
    ...
    <section class="tours2 section-padding bg-lightnav">
        <div class="container">
            ...
            <div class="row justify-content-center mb-40">
                <div class="col-md-8 text-center">
                    <div class="section-subtitle"><span>What Our Diners Say</span></div>
            ...
            <div class="row">
                ...
                <div class="col-md-7">
                    ...
                    <div style="text-align:center;padding:60px 30px;background:#fff;border-radius:8px;border:2px dashed #e0ddd4;">
                        ...
                        <p style="color:#999;font-size:14px;margin-bottom:0;">Be the first to review <strong>{{ $business->name }}</strong>.<br>Your feedback helps other diners make better choices.</p>
                    </div>
                    @endforelse
                </div>
                ...
                <div class="col-md-5">
                    <div style="background:#fff;border-radius:8px;padding:32px;box-shadow:0 2px 16px rgba(0,0,0,.08);position:sticky;top:80px;">
                        ...
                        <div style="text-align:center;margin-bottom:24px;padding-bottom:20px;border-bottom:1px solid #f0ede6;">
                            ...
                            <div class="section-subtitle" style="justify-content:center;"><span>Share Your Experience</span></div>
                        ...
                        @auth
                            ...
                            <form method="POST" action="{{ route('businesses.reviews.store', $business) }}" class="item-form contac__form">
                                ...
                                <div class="form-group">
                                    <textarea name="body" rows="4" placeholder="Tell us about your dining experience...">{{ old('body', $userReview?->body) }}</textarea>
                                </div>
                        ...
                        <div style="text-align:center;padding:20px 10px;">
                            ...
                            <p style="color:#888;font-size:14px;line-height:1.7;margin-bottom:24px;">
                                Dined at {{ $business->name }}?<br>Share your experience to help other diners.
                            </p>
                            <div class="butn-dark">
    ...
    <section id="reservation" class="tours2 section-padding bg-lightnav">
        <div class="container">
            <div class="row">
                <div class="col-md-8">
                    <div class="section-subtitle"><span>Book a Table</span></div>
                    <div class="section-title">Reserve at <span>{{ $business->name }}</span></div>
                    <p>Would you like to book a table at {{ $business->name }}? Fill in your details below and we will confirm your reservation.</p>
                    ...
                    <form method="POST" action="{{ route('contact.submit') }}" class="right-sidebar item-form contac__form mt-30">
                        @csrf
                        <input type="hidden" name="subject" value="Table Reservation: {{ $business->name }}">
                        <div class="row">
                            <div class="col-md-6 form-group">
                                <input name="name" type="text" placeholder="Your Full Name *" value="{{ old('name') }}" required>
                            </div>
                            <div class="col-md-6 form-group">
                                <input name="email" type="email" placeholder="Your Email *" value="{{ old('email') }}" required>
                            </div>
                            <div class="col-md-6 form-group">
                                <input name="phone" type="text" placeholder="Phone / WhatsApp" value="{{ old('phone') }}">
                            </div>
                            <div class="col-md-6 form-group">
                                <input name="arrival_date" type="text" placeholder="Date & Time Preference" value="{{ old('arrival_date') }}">
                            </div>
                            <div class="col-md-12 form-group">
                                <textarea name="message" cols="30" rows="4" placeholder="Number of guests, dietary requirements, special occasions...">{{ old('message') }}</textarea>
                            </div>
                            <div class="col-md-12">
                                <button class="btn btn-primary" type="submit"><span>Send Reservation Request</span></button>
                            </div>
                        </div>
                    </form>
                </div>
                ...
                <div class="col-md-4">
                    ...
                    <div class="widget clearfix usful-links mt-30">
                        ...
                        <ul>
                            <li><a href="{{ route('restaurants.index') }}"><i class="ti-arrow-right"></i> All Restaurants</a></li>
                            <li><a href="{{ route('hotels.index') }}"><i class="ti-arrow-right"></i> Hotels</a></li>
        ...
        <div class="container">
            <div class="row justify-content-center mb-30">
                <div class="col-md-8 text-center">
                    ...
                    <div class="section-title">Similar <span>Restaurants</span></div>
                </div>
            </div>
            <div class="row">
                @foreach($relatedRestaurants->take(3) as $related)
                <div class="col-md-4 col-sm-6 mb-30">
                    <div class="item">
                        <a href="{{ route('restaurants.show', $related->slug) }}">
                            <div class="position-re o-hidden">
                                @if($related->cover_photo)
                                    <img src="{{ \App\Helpers\Cms::imageUrl($related->cover_photo) }}" alt="{{ $related->name }}">
                                @else
                                    <img src="{{ asset('annapurna/img/restaurants/default-restaurant.jpg') }}" alt="{{ $related->name }}">
                                @endif
                            </div>
                            @if($related->subtitle)
                        ...
                        <div class="con">
                            <h5><a href="{{ route('restaurants.show', $related->slug) }}">{{ $related->name }}</a></h5>
                            ...
                            <div class="row facilities">
                                <div class="col col-md-12"><ul>
                                    ...
                                    @if($related->opening_hours)<li><i class="ti-time"></i> {{ Str::limit($related->opening_hours, 30) }}</li>@endif
                                </ul></div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="row mt-20">
                <div class="col-md-12 text-center">
                    <div class="butn-dark">
                        <a href="{{ route('restaurants.index') }}"><span>View All Restaurants <i class="ti-arrow-right"></i></span></a>
                    </div>
                </div>
            </div>
        </div>
