...
class RedirectResource extends Resource
{
    ...
    public static function form(Form $form): Form
    {
        return $form->schema([
            Forms\Components\TextInput::make('from_url')
                ...
                ->prefix('/')
                ->helperText('URL path to redirect from (e.g. /old-page)'),
            Forms\Components\TextInput::make('to_url')
                ->required()
                ->helperText('Destination URL (e.g. /new-page or https://example.com)'),
    ...
    public static function table(Table $table): Table
    {
        return $table
            ->columns([
                Tables\Columns\TextColumn::make('from_url')->searchable()->copyable(),
                Tables\Columns\TextColumn::make('to_url')->limit(50)->copyable(),
